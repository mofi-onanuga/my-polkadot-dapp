...
export type PolkadotDispatchError = Anonymize<Iasuqahos5nsl>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type PolkadotCallData = Anonymize<I9slagtkgsv9j0> & {
    value: {
        type: string;
    };
};
