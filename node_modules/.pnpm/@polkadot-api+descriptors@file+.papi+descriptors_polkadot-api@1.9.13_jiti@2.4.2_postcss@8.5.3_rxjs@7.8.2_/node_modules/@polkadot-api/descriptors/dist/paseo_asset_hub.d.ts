...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<Ia3633h9pfkn7c>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<Ic8op9rkehldqm>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<I1oss3cbkjdb8e>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<Ic8op9rkehldqm>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I8gc4nnphta0mn>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<Ic8op9rkehldqm>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<Idd3pmare7cfmb>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<Iegcuqs7gopsn>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I4kik4fr82b8sg>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<I93qep6uulr6h3>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<Iah6ud3n0qbnq5>>;
    };
    Assets: {
        /**
    ...
    Sudo: {
         ...
         */
        sudo: TxDescriptor<Anonymize<I1upc9064fdsne>>;
        /**
         *Authenticates the sudo key and dispatches a function call with `Root` origin.
         *This function does not check the weight of the call, and instead allows the
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_unchecked_weight: TxDescriptor<Anonymize<Idd3pmare7cfmb>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        sudo_as: TxDescriptor<Anonymize<Iebffjs9r0dqo4>>;
        /**
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I70us7eipq4rid>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Iea0lsafm2p8h3>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<Ifaqukm8une709>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I9boj13dfc48k>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<Ia2mdf02dvjvfj>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I9boj13dfc48k>>;
        /**
    ...
    Sudo: {
         ...
         */
        Sudid: PlainDescriptor<Anonymize<I82lkrm3332ng0>>;
        /**
         ...
         */
        SudoAsDone: PlainDescriptor<Anonymize<I82lkrm3332ng0>>;
    };
};
type IError = {
    System: {
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I7l4uu3dsbji>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ibbsf5u46f61r4>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ibbsf5u46f61r4>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<Ibbsf5u46f61r4>], Anonymize<Ic4l4p5329mqka>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<I28cpqn91oi3ns>>;
    };
    /**
...
export type Paseo_asset_hubDispatchError = Anonymize<Id1b6jh4cusamh>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Paseo_asset_hubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubCalls = TxFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Paseo_asset_hubCallData = Anonymize<Ibbsf5u46f61r4> & {
    value: {
        type: string;
    };
};
export type Paseo_asset_hubWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
