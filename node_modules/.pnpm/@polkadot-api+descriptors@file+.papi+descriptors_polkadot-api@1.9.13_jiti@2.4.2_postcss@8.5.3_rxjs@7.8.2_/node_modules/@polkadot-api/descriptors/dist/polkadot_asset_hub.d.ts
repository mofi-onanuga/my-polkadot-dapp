...
type IStorage = {
    System: {
         ...
         */
        Events: StorageDescriptor<[], Anonymize<I8vp3ucscuqg86>, false, never>;
        /**
    ...
    Balances: {
         ...
         */
        Holds: StorageDescriptor<[Key: SS58String], Anonymize<Ibjr62thfhmen3>, false, never>;
        /**
...
type ICalls = {
    ...
    Utility: {
         ...
         *event is deposited.
         */
        batch: TxDescriptor<Anonymize<I3g7j9h7jht691>>;
        /**
         ...
         *The dispatch origin for this call must be _Signed_.
         */
        as_derivative: TxDescriptor<Anonymize<Iar8b84jas6g1>>;
        /**
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        batch_all: TxDescriptor<Anonymize<I3g7j9h7jht691>>;
        /**
         ...
         *- O(1).
         */
        dispatch_as: TxDescriptor<Anonymize<I9cg6e96hjjme2>>;
        /**
         *Send a batch of dispatch calls.
         ...
         *- O(C) where C is the number of calls to be batched.
         */
        force_batch: TxDescriptor<Anonymize<I3g7j9h7jht691>>;
        /**
         ...
         *The dispatch origin for this call must be _Root_.
         */
        with_weight: TxDescriptor<Anonymize<I97jqcgk4bcg3n>>;
    };
    Multisig: {
        /**
         ...
         */
        as_multi_threshold_1: TxDescriptor<Anonymize<I9p3t2kcp8f20j>>;
        /**
         ...
         */
        as_multi: TxDescriptor<Anonymize<I4mqa3vatnn2lb>>;
        /**
         *Register approval for a dispatch to be made from a deterministic composite account if
         *approved by a total of `threshold - 1` of `other_signatories`.
         *
    ...
    Proxy: {
         ...
         */
        proxy: TxDescriptor<Anonymize<Icu9npfap4elaq>>;
        /**
         ...
         *- `call`: The call to be made by the `real` account.
         */
        proxy_announced: TxDescriptor<Anonymize<I4fbn1vad0gvp8>>;
    };
    Assets: {
        /**
    ...
    ForeignAssets: {
         ...
         *  guarantee to keep the sender asset account alive (true).
         */
        transfer_all: TxDescriptor<Anonymize<Ic6a3rlcsqmjnp>>;
    };
    PoolAssets: {
        /**
         *Issue a new class of fungible assets from a public origin.
...
type IEvent = {
    System: {
         ...
         *An extrinsic failed.
         */
        ExtrinsicFailed: PlainDescriptor<Anonymize<I7g72pd5e26jk0>>;
        /**
         *`:code` was updated.
         */
    ...
    Utility: {
         ...
         *well as the error.
         */
        BatchInterrupted: PlainDescriptor<Anonymize<Ifqbis6nqo7ebb>>;
        /**
         ...
         */
        ItemFailed: PlainDescriptor<Anonymize<I19gn0eidsg4mb>>;
        /**
         *A call was dispatched.
         */
        DispatchedAs: PlainDescriptor<Anonymize<I7kun49uv35bgq>>;
    };
    Multisig: {
        /**
         ...
         */
        MultisigExecuted: PlainDescriptor<Anonymize<If35js3cp0m9nh>>;
        /**
    ...
    Proxy: {
         ...
         */
        ProxyExecuted: PlainDescriptor<Anonymize<I7kun49uv35bgq>>;
        /**
...
type IRuntimeCalls = {
    ...
    BlockBuilder: {
         ...
         * this block or not.
         */
        apply_extrinsic: RuntimeDescriptor<[extrinsic: Binary], Anonymize<I1efgsn6u9dfti>>;
        /**
    ...
    TransactionPaymentCallApi: {
         ...
         */
        query_call_info: RuntimeDescriptor<[call: Anonymize<Ib38e3m2bhrav3>, len: number], Anonymize<I6spmpef2c7svf>>;
        /**
         * Query fee details of a given encoded `Call`.
         */
        query_call_fee_details: RuntimeDescriptor<[call: Anonymize<Ib38e3m2bhrav3>, len: number], Anonymize<Iei2mvq0mjvt81>>;
        /**
    ...
    DryRunApi: {
         ...
         * Dry run call.
         */
        dry_run_call: RuntimeDescriptor<[origin: Anonymize<I48v5riethqckl>, call: Anonymize<Ib38e3m2bhrav3>], Anonymize<I5mpf9ieem1p8b>>;
        /**
         * Dry run XCM program
         */
        dry_run_xcm: RuntimeDescriptor<[origin_location: XcmVersionedLocation, xcm: XcmVersionedXcm], Anonymize<Iceqok2pmntdsu>>;
    };
    /**
...
export type Polkadot_asset_hubDispatchError = Anonymize<Ici671kun64gm5>;
type PalletsTypedef = {
    __storage: IStorage;
    __tx: ICalls;
    __event: IEvent;
...
export type Polkadot_asset_hubQueries = QueryFromPalletsDef<PalletsTypedef>;
export type Polkadot_asset_hubCalls = TxFromPalletsDef<PalletsTypedef>;
export type Polkadot_asset_hubEvents = EventsFromPalletsDef<PalletsTypedef>;
export type Polkadot_asset_hubErrors = ErrorsFromPalletsDef<PalletsTypedef>;
export type Polkadot_asset_hubConstants = ConstFromPalletsDef<PalletsTypedef>;
export type Polkadot_asset_hubCallData = Anonymize<Ib38e3m2bhrav3> & {
    value: {
        type: string;
    };
};
export type Polkadot_asset_hubWhitelistEntry = PalletKey | ApiKey<IRuntimeCalls> | `query.${NestedKey<PalletsTypedef['__storage']>}` | `tx.${NestedKey<PalletsTypedef['__tx']>}` | `event.${NestedKey<PalletsTypedef['__event']>}` | `error.${NestedKey<PalletsTypedef['__error']>}` | `const.${NestedKey<PalletsTypedef['__const']>}`;
