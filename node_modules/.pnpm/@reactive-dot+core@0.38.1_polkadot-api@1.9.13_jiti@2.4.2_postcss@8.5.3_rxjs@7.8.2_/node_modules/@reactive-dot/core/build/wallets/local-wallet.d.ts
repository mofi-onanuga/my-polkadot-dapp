 ...
 * @experimental
 */
export declare abstract class LocalWallet<TAccount extends Pick<PolkadotSignerAccount, "id">, TOptions extends WalletOptions, TStorageKey extends string> extends Wallet<TOptions, TStorageKey> {
    /**
     * @experimental
     */
